...
| パス | 説明 | 最終更新 | 優先度 |
|---|---|---|---|
| CLAUDE.md | リポジトリ運用ガイド（軽量コア） | 2026-04-18 | 高 |
| tasks.md | タスク管理（完了/進行中/バックログ） | 2026-04-18 | 高 |
| file_index.md | このファイル。全ファイル一覧 | 2026-04-18 | 高 |
...
| パス | 説明 | 最終更新 | 優先度 |
|---|---|---|---|
| docs/rules-search-product.md | 商品検索詳細ルール（失敗パターン・3ゲート検証・ワークフロー） | 2026-04-18 | 高 |
